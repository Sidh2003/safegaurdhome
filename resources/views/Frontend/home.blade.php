...
@section('content')
    <div class="tp-sidebar-menu ">
        ...
        <div class="side-logo mb-20">
            <a href="/"><img src="/frontend/assets/img/logo/logo.png" alt="logo"></a>
        </div>
            ...
            <div class="row text-center">
                <div class="col-12">
                    <div class="tp-section-box tp-section-box-2 p-relative mb-45">
                        ...
                        <p>At Safe Gaurd Home, we offer expert security solutions tailored to protect what matters
                            most.
                ...
                <div class="col-lg-4 col-md-6">
                    <div class="tpsvbox mb-30">
                        ...
                        <div class="tpsvbox__content text-center">
                            ...
                            <p class="m-0">Secure your campus with Safe Gaurd Home. Monitor and protect anytime,
                                anywhere.
                            </p><br>
                        </div>
                    </div>
    ...
    <div class="team-details-area pt-80 pb-20">
        <div class="container">
                    ...
                    <div class="team-info-main pt-0 pl-45">
                        <div class="team-details-info">
                            ...
                            <p>With over 15 years of expertise in the field, we have been committed to delivering the best
                                in security and automation solutions. Safe Gaurd Home has consistently ranked among the
                                top
            ...
            <div class="row">
                <div class="col-xl-6">
                    <div class="team-member">
                        <img src="/frontend/my_img/why_choose.png" alt="Why Choose Safe Gaurd Home">
                    </div>
                    <br>
                </div>
                <div class="col-xl-6">
